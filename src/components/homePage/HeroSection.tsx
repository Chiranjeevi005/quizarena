...
export function HeroSection() {
  ...
  return (
    <section ref={containerRef} style={{ position: "relative" }} className="relative pt-24 pb-16 sm:pb-24 lg:pt-36 lg:pb-40 overflow-hidden bg-white">
          ...
          >
            ...
            >
              <div className="flex flex-col group cursor-default">
                <span className="text-2xl sm:text-3xl font-black text-navy group-hover:text-primary transition-colors">120+</span>
              ...
              <div className="flex flex-col group cursor-default">
                <span className="text-2xl sm:text-3xl font-black text-navy text-left sm:text-center group-hover:text-primary transition-colors">Real-time</span>
