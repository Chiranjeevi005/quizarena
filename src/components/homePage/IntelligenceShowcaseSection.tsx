...
export function IntelligenceShowcaseSection() {
  ...
  return (
    <section ref={sectionRef} style={{ position: "relative" }} className="py-24 lg:py-32 bg-[#FAFBFF] relative overflow-hidden border-y border-gray-100">
          ...
          <div className="w-full lg:w-7/12 flex flex-col gap-12 sm:gap-16 lg:gap-28 lg:pt-4 lg:pb-16">
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-3">
                <motion.div whileHover={{ scale: 1.05, y: -2 }} className="inline-flex items-center gap-2 text-[11px] sm:text-sm font-bold text-navy bg-white px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-full border border-gray-200 shadow-sm cursor-default">
                  <Target className="w-4 h-4 text-navy/50" /> Q. 42 / 100
                </motion.div>
                <motion.div whileHover={{ scale: 1.05, y: -2 }} className="inline-flex items-center gap-2 text-[11px] sm:text-sm font-bold text-primary bg-primary/5 px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-full border border-primary/20 shadow-sm cursor-default">
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <motion.div whileHover={{ scale: 1.05, y: -2 }} className="inline-flex items-center gap-2 text-[11px] sm:text-sm font-bold text-red-600 bg-red-50 px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-full border border-red-100 shadow-sm cursor-default">
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <motion.div whileHover={{ scale: 1.05, y: -2 }} className="inline-flex items-center gap-2 text-[11px] sm:text-sm font-bold text-emerald-600 bg-emerald-50 px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-full border border-emerald-100 shadow-sm cursor-default">
