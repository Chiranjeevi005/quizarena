    ...
    const executionSteps: ExecutionStep[] = [
      {
        ...
        description: "Pre-flight artifact check",
      ...
      },
      {
        ...
        description: "Confirm runtime readiness",
      ...
      },
      {
        ...
        order: 3,
        name: "Warm Runtime",
        description: "Prepare runtime environment",
        action: "WARM_RUNTIME",
        parameters: {},
        status: "PENDING",
      },
      {
        ...
        order: 4,
        name: "Activate",
        description: "Activate the competition in runtime",
        action: "ACTIVATE",
        parameters: {},
        status: "PENDING",
      },
      ...
      },
      {
        ...
        order: 7,
        name: "Emit Events",
        description: "Emit published events",
        action: "EMIT_EVENTS",
        parameters: {},
        status: "PENDING",
      },
