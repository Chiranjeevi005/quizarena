...
export default function QuestionWorkspaceLayout({ children }: { children: React.ReactNode }) {
  return (
      ...
      <div className="flex flex-1 overflow-hidden">
        <aside className="w-64 border-r border-gray-200 bg-white p-4 overflow-y-auto">
          <nav className="space-y-1">
            ...
            <NavItem
              href="/super-admin/questions/workspace/recommendations"
