      ...
      <header className="border-b border-gray-800 bg-gray-950 px-6 py-4 flex items-center justify-between">
        ...
        <nav className="flex items-center space-x-6 text-sm font-medium">
          <div className="mr-4 text-xs bg-gray-800 text-gray-400 px-2 py-1 rounded flex items-center gap-1 border border-gray-700">
            <span>Press</span> <kbd className="font-mono text-gray-200">⌘K</kbd>{" "}
            <span>to search</span>
          </div>
          <a href="/admin/operations" className="text-gray-300 hover:text-white transition-colors">
            Operations
          </a>
          <a href="/admin/users" className="text-gray-300 hover:text-white transition-colors">
            Users & Roles
          </a>
          <a href="/admin/audit" className="text-gray-300 hover:text-white transition-colors">
            Audit Explorer
          </a>
