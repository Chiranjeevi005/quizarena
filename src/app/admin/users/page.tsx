  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-gray-400 text-sm">Manage users, assign roles, and configure granular permissions.</p>
      </div>
          ...
          <tbody className="divide-y divide-gray-800/50">
            ...
            <tr className="hover:bg-gray-800/30 transition-colors">
              ...
              <td className="px-6 py-4">
                <span className="bg-purple-500/20 text-purple-400 px-2 py-1 rounded text-xs font-semibold">ADMIN</span>
              </td>
              <td className="px-6 py-4">
            ...
            <tr className="hover:bg-gray-800/30 transition-colors">
              ...
              <td className="px-6 py-4">
                <span className="bg-gray-500/20 text-gray-400 px-2 py-1 rounded text-xs font-semibold">USER</span>
              </td>
              <td className="px-6 py-4">
                <span className="bg-green-500/20 text-green-400 px-2 py-1 rounded text-xs font-semibold">ACTIVE</span>
              </td>
