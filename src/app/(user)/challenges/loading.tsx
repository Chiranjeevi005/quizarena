            ...
            <div className="relative z-10 w-full bg-black/30 border-t border-white/5 px-8 py-4">
              <div className="flex flex-wrap items-center justify-between gap-6 md:gap-8 max-w-4xl">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className={`flex items-center gap-3 ${i > 2 ? (i === 3 ? "hidden sm:flex" : "hidden lg:flex") : ""}`}
                  >
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="bg-white rounded-2xl border border-gray-100 p-6 h-[240px] flex flex-col justify-between shadow-sm"
                >
                  <div>
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[1, 2].map((i) => (
                <div
                  key={i}
                  className="bg-navy rounded-2xl border border-amber-500/20 p-6 md:p-8 h-[360px] flex flex-col relative overflow-hidden"
                >
          ...
          <section className="space-y-6">
            ...
            <div className="space-y-4">
              {[1, 2].map((i) => (
                <div
                  key={i}
                  className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-6"
                >
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden flex flex-col">
              ...
              <div className="p-5 space-y-5">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className={`flex justify-between items-center ${i < 4 ? "pb-3 border-b border-gray-100" : ""}`}
                  >
