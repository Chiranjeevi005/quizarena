 ...
 *
 * Placeholder for quiz challenges with proper empty state.
...
import { Trophy, Target, Clock, ArrowRight, Play, Search, Filter } from "lucide-react";
    ...
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500">Test your knowledge with practice quizzes</p>
        </div>
      </div>
