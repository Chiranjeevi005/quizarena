...
export default function IntelligenceWorkspaceLayout({
  children,
}: {
    ...
    <div className="flex min-h-screen flex-col bg-gray-50 text-gray-900">
      <header className="flex items-center justify-between bg-emerald-900 px-6 py-4 text-white shadow-md">
        <div className="flex items-center gap-4">
          ...
          <div className="rounded bg-emerald-800 px-2 py-1 text-xs font-medium text-emerald-100">SA-06 Command Center</div>
        </div>
      </header>
