...
export default function CommunicationWorkspaceLayout({
  children,
}: {
    ...
    <div className="flex min-h-screen flex-col bg-gray-50 text-gray-900">
      <header className="flex items-center justify-between bg-zinc-900 px-6 py-4 text-white shadow-md">
        <div className="flex items-center gap-4">
          ...
          <div className="rounded bg-zinc-800 px-2 py-1 text-xs font-medium text-zinc-100">SA-08 Control Center</div>
        </div>
      </header>
