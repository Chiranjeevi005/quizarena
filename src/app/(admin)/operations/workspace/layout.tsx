...
export default function OperationsWorkspaceLayout({
  children,
}: {
    ...
    <div className="flex min-h-screen flex-col bg-gray-50 text-gray-900">
      <header className="flex items-center justify-between bg-zinc-900 px-6 py-4 text-white shadow-md">
        <div className="flex items-center gap-4">
          ...
          <div className="rounded bg-zinc-800 px-2 py-1 text-xs font-medium text-zinc-100">SA-07 Control Center</div>
        </div>
      </header>
      ...
      <div className="flex flex-1 overflow-hidden">
        <aside className="w-64 border-r border-gray-200 bg-white p-4 overflow-y-auto">
          <nav className="space-y-1">
            ...
            <NavItem href="/operations/workspace/command-center" label="Command Center" className="font-bold text-red-600 bg-red-50 mt-4" />
