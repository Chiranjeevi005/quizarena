import { Competition, CompetitionSection, CompetitionQuestion, CompetitionConfig, CompetitionEconomics, CompetitionEligibility, Question } from '@/generated/prisma';
import { 
...
export class SnapshotBuilder {
  ...
  static buildQuestionsSnapshot(compQuestions: (CompetitionQuestion & { question: Question & { options?: any[] } })[]): SnapshotQuestionDTO[] {
    return compQuestions.map(cq => ({
      id: cq.id,
  ...
  static buildConfigSnapshot(economics: CompetitionEconomics | null, eligibility: CompetitionEligibility | null): SnapshotConfigDTO {
    return {
      economics: economics ? {
