    ...
    <>
      ...
      <div className="lg:hidden flex flex-col items-center justify-center min-h-screen bg-slate-950 text-center p-6">
        ...
        <p className="text-slate-400 max-w-sm">
          Please use a desktop or laptop computer for the best assessment experience. Mobile and
          small tablet devices are currently not supported for active competitions.
        </p>
      </div>
    </>
  );
