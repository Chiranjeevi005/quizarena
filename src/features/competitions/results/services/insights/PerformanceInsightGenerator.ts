  ...
  public static generate(
    ...
    if (skipped > totalQuestions * 0.2) {
      insights.push({
        ...
        description:
          "You skipped a significant portion of questions. Consider attempting more questions to maximize your scoring potential, unless negative marking strategies apply.",
    ...
    if (avgTime < 10) {
      insights.push({
        ...
        description:
          "Your average time per question was very fast. Ensure you are reading questions thoroughly to avoid silly mistakes.",
      ...
      insights.push({
        ...
        description:
          "You spent considerable time per question. Practicing timed mocks may help improve your overall speed.",
        metricValue: `${Math.round(avgTime)}s/question`,
      });
    } else {
      insights.push({
        ...
        description:
          "Your time management was balanced, allowing adequate time per question without rushing.",
        metricValue: `${Math.round(avgTime)}s/question`,
      });
    }
