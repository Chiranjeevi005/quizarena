...
export interface PaymentGateway {
  ...
  createOrder(options: { amount: number; currency: string; receipt: string; notes?: Record<string, string> }): Promise<{ id: string; amount: number; currency: string; status: string; receipt: string }>;
  ...
  createRefund(options: { paymentId: string; amount?: number; receipt?: string; notes?: Record<string, string> }): Promise<{ id: string; amount: number; status: string }>;
